...
$PBTS_BIN_DIR/pbjs -t static -W es6 /Users/haiboyuan/src/program/server/proto/trip.proto -no-create --no-encode --no-verify --no-delimited -o $PBTS_OUT_DIR/trip_pb.js
